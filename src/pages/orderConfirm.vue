      ...
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            ...
            <input type="text" class="input" placeholder="手机号" v-model="checkedItem.receiveMobile">
          </div>
          <div class="item">
            <select name="province" v-model="checkedItem.receiveProvince">
              <option value="北京">北京</option>
              <option value="广东">广东</option>
              <option value="上海">上海</option>
            </select>
            <select name="city" v-model="checkedItem.receiveCity">
              <option value="北京">北京</option>
              <option value="广州">广州</option>
              <option value="上海">上海</option>
            </select>
            <select name="district" v-model="checkedItem.receiveDistrict">
          ...
          <div class="item">
            <textarea name="street" v-model="checkedItem.receiveAddress"></textarea>
          </div>
          <div class="item">
            <input type="text" class="input" placeholder="邮编" v-model="checkedItem.receiveZip">
          </div>
        </div>
      </template>
    </modal>
